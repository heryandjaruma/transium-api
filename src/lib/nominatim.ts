...
// comes back empty for an address — never per keystroke — so a single ad-hoc request
// per user search stays well within that. If usage ever grows beyond occasional

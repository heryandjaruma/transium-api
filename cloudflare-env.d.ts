/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: d2041ca501aa3351a3409d1f7afe9a49)
// Runtime types generated with workerd@1.20260811.1 2026-08-13 global_fetch_strictly_public
interface __BaseEnv_CloudflareEnv {
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	NEXTJS_ENV: string;
	WORKER_SELF_REFERENCE: Fetcher /* transium-api */;
}
